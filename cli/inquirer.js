  ...
  askWalletAndPostageQuestions: () => {
    const questions = [
      ...
      },
      {
        ...
        type: 'input',
        message:
                    'Enter your SLP Address, which will receive all paid postage:',
    ...
    const questions = [
      {
        ...
        validate: async function (value) {
          if (!value) { return 'Token not found. Please enter a valid token Id. Check simpleledger.info for more information.' }
          return true
        }
      },
      {
